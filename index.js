...
class Airplane {
 ...
 class Lambdasian {
   constructor (thing){
    ...
    speak(){
      return `Hello many name is ${this.name}, I am from ${this.location}`;
    }
  }
 ...
 class Student extends Lambdasian{
   constructor(thing1){
     super(thing1);
     this.previousBackground=thing1.previousBackground;
     this.specialty=thing1.specialty;
     this.className=thing1.className;
     this.favSubjects=thing1.favSubjects;
   }
     listSubjects(){
